...
//  Вместо  applicationContext.xml используем класс MyConfig.java
//  Прописываем конфигурационные данные которые были в applicationContext.xml
...
public class MyConfig {
    ...
    public DataSource dataSource() {
        ...
        try {
            ...
            dataSource.setPassword("bestuser123!");
